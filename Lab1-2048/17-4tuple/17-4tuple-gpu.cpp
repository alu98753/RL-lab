...
// class feature {
// public:
//     feature(size_t len) : length(len), weight(nullptr), d_weight(nullptr) {
//         // Allocate host memory
//         weight = alloc(len);

//         // Allocate device memory
//         cudaMalloc(&d_weight, length * sizeof(float));

//         // Initialize device memory
//         cudaMemset(d_weight, 0, length * sizeof(float));
//     }

//     feature(feature&& f)
//         : length(f.length), weight(f.weight), d_weight(f.d_weight) {
//         f.weight = nullptr;
//         f.d_weight = nullptr;
//     }
...
// class learning {
// public:
//     learning() : score_file("scores.txt") {}
//     ~learning() {
...
// 	tdl.add_feature(new pattern({ 2, 6, 10, 14}));
...
// 	tdl.add_feature(new pattern({ 8, 9, 8, 12}));
